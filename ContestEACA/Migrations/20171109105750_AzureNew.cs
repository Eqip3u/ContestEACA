        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProvisionId = table.Column<int>(type: "int", nullable: true),
                    Rewarding = table.Column<DateTime>(type: "datetime2", nullable: false),
                    StartTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    WhoCreatedId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    WhoModifiedId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Contests_AspNetUsers_WhoCreatedId",
                        column: x => x.WhoCreatedId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Contests_AspNetUsers_WhoModifiedId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModerateUsersContests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ModerateUsersContests_Contests_ContestId",
                        column: x => x.ContestId,
                        principalTable: "Contests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ModerateUsersContests_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contests_WhoCreatedId",
                table: "Contests",
                column: "WhoCreatedId");

            migrationBuilder.CreateIndex(
                name: "IX_Contests_WhoModifiedId",
                table: "Contests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModerateUsersContests_ContestId",
                table: "ModerateUsersContests",
                column: "ContestId");

            migrationBuilder.CreateIndex(
                name: "IX_ModerateUsersContests_UserId",
                table: "ModerateUsersContests",
                column: "UserId");
